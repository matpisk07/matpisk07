...
Passionné par l'électronique embarquée et l'informatique, je conçois des systèmes complets, du prototypage hardware jusqu'au développement firmware. Je suis à la recherche d'un **stage technique de 6 semaines (Juin-Juillet 2026)** pour valider ma première année.
